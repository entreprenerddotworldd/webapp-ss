...
function parseSemgrep() {
  ...
  return { total: results.length, bySeverity: bySev };
}
...
function parseTrivy() {
  ...
  return { total: vulns.length, vulns };
}
...
<div class="section" id="sast">
  <div class="section-header">
    ...
    <span class="section-count">${semgrep.total} finding${semgrep.total !== 1 ? "s" : ""}</span>
  </div>
  ${
    semgrep.total === 0
...
<div class="section" id="sca">
  <div class="section-header">
    ...
    <span class="section-count">${trivy.total} vulnerable package${trivy.total !== 1 ? "s" : ""}</span>
  </div>
  ${
    trivy.total === 0
...
<div class="section" id="dast-nuclei">
  <div class="section-header">
    ...
    <span class="section-count">${nuclei.total} finding${nuclei.total !== 1 ? "s" : ""}</span>
  </div>
  <table>
